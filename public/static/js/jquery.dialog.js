    ...
    $.uedWidget('ued.Dialog', {
	    ...
	    _createDialogDom : function($el, options, _define){
			...
			if(!options.modal){
				...
				var $Mask = _define.$Mask = $('<div style="position: fixed;z-index:9999;top:0;left:0;right:0;bottom:0;display:none;background:#000;opacity:.3"></div>');
				$('body').append($Mask);
			}
